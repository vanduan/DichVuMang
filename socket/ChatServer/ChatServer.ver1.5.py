...
class ChatServer:
            ...
            for sock in sread:
                if sock == self.srvsock:
                    ...
                    if my_str == '':
                        ...
                        # tang so ket noi cho phep
                        self.numberconnect+=1
                    elif my_str[1:2] =='\n':
                        host, port = sock.getpeername()
    ...
    def accept_new_connection( self ):
        ...
        # tu choi ket noi
        if self.numberconnect == 0:
            newsock.send("======> Server chat is full, closed connect\r\n")
            newsock.close
        else:
            # giam so ket noi cho phep
            self.numberconnect-=1
